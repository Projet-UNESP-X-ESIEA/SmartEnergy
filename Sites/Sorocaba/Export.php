    ...
    <div class="ContainerDataForm" id="dataForm">
      ...
      <!-- data selection cheboxes -->
         <div class="containerDataInfo" >
           ...
           <label for="toggle2"> RECORD </label>
            -->

           <input id="toggle3" type="checkbox" name="case3">
           <label for="toggle3"> Panel Temperature </label>

           <input id="toggle4" type="checkbox" name="case4">
           <label for="toggle4"> Global Radiation </label>

           <input id="toggle5" type="checkbox" name="case5">
           <label for="toggle5"> Radiation ML01 </label>

           <input id="toggle6" type="checkbox" name="case6">
           <label for="toggle6"> Radiation ML02 </label>

           <input id="toggle7" type="checkbox" name="case7">
           <label for="toggle7"> Rain </label>

           <input id="toggle8" type="checkbox" name="case8">
           <label for="toggle8"> Air Temperature </label>

           <input id="toggle9" type="checkbox" name="case9">
           <label for="toggle9"> Wind Speed</label>

           <input id="toggle10" type="checkbox" name="case10">
           <label for="toggle10"> Wind Direction </label>

           <input id="toggle11" type="checkbox" name="case11">
           <label for="toggle11"> Air Pressure </label>
